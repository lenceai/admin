...
os.makedirs('output/log', exist_ok=True)  # Create log directory

# Set up logging with a dynamic filename
log_filename = f'output/log/gpfs_layout{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}.log'  # Updated path
...
logging.info(consolidated_data.tail().to_string())  # Replaced print with logging
...
output_csv_path = 'output/data/consolidated_data.csv'  # Updated path
...
output_csv_path = 'output/data/data.csv'  # Updated path
data.to_csv(output_csv_path, index=False)
logging.info(f'Filtered data CSV file saved to {output_csv_path}')
# logging.info('\nSelected columns data preview:')
logging.info(data.tail().to_string())  # Replaced print with logging
...
output_csv_path = 'output/data/layout_by_size.csv'  # Updated path
data.to_csv(output_csv_path, index=False)
...
sorted_data_by_cluster.to_csv('output/data/layout_by_cluster.csv', index=False)
...
# Save the grouped data to a CSV file
output_csv_path = 'output/data/grouped_data.csv'  # Updated path
